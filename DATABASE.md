...
The Kendrick Forrest Client Portal uses PostgreSQL as its primary database system. This document outlines the database schema, setup instructions, and usage guidelines.
